...
<div class="overlay" id="divAddPet_store">
	<div class="wrapperImages">
		...
		<div class="content">
			<div class="container">
				<div class="card">
					<div class="card-body">
						<form class="formADDEdit" method="post" action="{{ route('pet_store.store') }}" enctype="multipart/form-data">
							@csrf
							<div class="rowaddImages mb-3">
								<label	class="label">ناوی فرۆشگا</label>
								<div>
									<input type="text" name="name" class="form-control" required/>
								</div>
							</div>
							<div class="rowaddImages mb-3">
								<label class="label">ئیمێڵی فرۆشگا</label>
								<div>
				           ...
				           <input type="tel" name="phone_number" class="phone form-control" required/>
                            ...
                            <div class="rowaddImages mb-3">
								<label	class="label">ناوی فرۆشیار</label>
								<div>
